...
import useNavigationButtonTheme from "@/library/navigation/radix/useNavigationButtonTheme"
    ...
    <NavigationMenu.List {...props} data-testid={"navigation-list"}>
      <NavigationMenu.Item className={"relative"} data-testid={"navigation-item"}>
        ...
        >
          <span>{name}</span>
          <CaretDown
            size={IconConstants.md.rem}
            className={twMerge("transition", "group-data-[state=open]:-rotate-180")}
          />
        </NavigationMenu.Trigger>
